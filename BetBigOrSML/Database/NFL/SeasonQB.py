...
season_qb_collection = db['QB Season Statistics']
...
qb_stats = weekly_data[weekly_data['position'] == 'QB']
...
season_qb_collection.delete_many({})  # Clear existing season stats (if needed)
season_qb_collection.insert_many(season_stats_dict)
