...
season_wr_collection = db['WR Season Statistics']
...
season_stats = wr_stats.groupby('player_id').agg({
...
season_wr_collection.delete_many({})  # Clear existing season stats (if needed)
season_wr_collection.insert_many(season_stats_dict)

print(f"Full season WR stats have been successfully updated in MongoDB at {current_time}.")
