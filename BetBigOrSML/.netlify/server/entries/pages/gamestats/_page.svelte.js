...
const Page = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  ...
  $$result.css.add(css);
  return `${$$result.head += `<!-- HEAD_svelte-lm5hoi_START -->${$$result.title = `<title>${escape(pageTitle)}</title>`, ""}<!-- HEAD_svelte-lm5hoi_END -->`, ""} <h1 data-svelte-h="svelte-5pf52y">NFL Betting Platform</h1>  <section class="svelte-su4cro"><h2 data-svelte-h="svelte-izjzs7">Upcoming NFL Match ups</h2> <ul>${each(upcomingGames, (game) => {
