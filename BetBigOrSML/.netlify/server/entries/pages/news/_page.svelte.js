...
const Page = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  ...
  $$result.css.add(css);
  return `${$$result.head += `<!-- HEAD_svelte-lm5hoi_START -->${$$result.title = `<title>${escape(pageTitle)}</title>`, ""}<!-- HEAD_svelte-lm5hoi_END -->`, ""} <main><h1 data-svelte-h="svelte-rfi5hj">NFL News</h1>  <section class="svelte-1x1oje5"><h2 class="svelte-1x1oje5" data-svelte-h="svelte-iotczq">Team Articles</h2> <ul class="svelte-1x1oje5">${each(teamArticles, (article) => {
    return `<li class="svelte-1x1oje5"><p class="svelte-1x1oje5">${escape(article.description)}</p> </li>`;
  })}</ul></section>  <section class="svelte-1x1oje5"><h2 class="svelte-1x1oje5" data-svelte-h="svelte-sya79m">Player Articles</h2> <ul class="svelte-1x1oje5">${each(playerArticles, (article) => {
    return `<li class="svelte-1x1oje5"><p class="svelte-1x1oje5">${escape(article.description)}</p> </li>`;
  })}</ul></section>  <section class="svelte-1x1oje5"><h2 class="svelte-1x1oje5" data-svelte-h="svelte-1jic414">Betting Articles</h2> <ul class="svelte-1x1oje5">${each(bettingArticles, (article) => {
    return `<li class="svelte-1x1oje5"><p class="svelte-1x1oje5">${escape(article.description)}</p> </li>`;
  })}</ul></section> </main>`;
});
export {
